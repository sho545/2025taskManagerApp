...
public interface TasksApi {
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "[ { \"dueDate\" : \"2025-07-07T23:59:00Z\", \"description\" : \"Milk, eggs, bread\", \"id\" : \"d290f1ee-6c54-4b01-90e6-d701748f0851\", \"completed\" : false, \"title\" : \"Buy groceries\" }, { \"dueDate\" : \"2025-07-07T23:59:00Z\", \"description\" : \"Milk, eggs, bread\", \"id\" : \"d290f1ee-6c54-4b01-90e6-d701748f0851\", \"completed\" : false, \"title\" : \"Buy groceries\" } ]";
    ...
    default ResponseEntity<TaskDto> tasksIdGet(
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"dueDate\" : \"2025-07-07T23:59:00Z\", \"description\" : \"Milk, eggs, bread\", \"id\" : \"d290f1ee-6c54-4b01-90e6-d701748f0851\", \"completed\" : false, \"title\" : \"Buy groceries\" }";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
            }
